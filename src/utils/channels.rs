...
pub type ActionChannel =
    PubSubChannel<NoopRawMutex, EmergeMqttAction, ACTION_CAP, ACTION_SUBS, ACTION_PUBS>;
pub type ActionPub =
    Publisher<'static, NoopRawMutex, EmergeMqttAction, ACTION_CAP, ACTION_SUBS, ACTION_PUBS>;
pub type ActionSub =
...
pub type EventPub =
    Publisher<'static, NoopRawMutex, RobotEvents, EVENT_CAP, EVENT_SUBS, EVENT_PUBS>;
pub type EventSub =
    Subscriber<'static, NoopRawMutex, RobotEvents, EVENT_CAP, EVENT_SUBS, EVENT_PUBS>;
